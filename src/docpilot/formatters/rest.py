"""reStructuredText (reST) docstring formatter.

Implements the reStructuredText documentation format commonly used in Python:
https://docutils.sourceforge.io/rst.html

This is similar to Sphinx format but uses more traditional reStructuredText
field list syntax without the colon prefix on field names.
"""
...
class RestFormatter(BaseFormatter):
    """Formatter for reStructuredText (reST) docstrings.

    reStructuredText style uses field lists with :directive: syntax:
    ...
    def __init__(
        ...
        """Initialize reStructuredText formatter.
    ...
    def format(self, element: CodeElement, docstring_content: str) -> str:
        """Format a docstring in reStructuredText style.
        ...
        Returns:
            Formatted reStructuredText docstring
        """
    ...
    def format_returns(self, return_type: str | None, description: str) -> str:
        ...
        # :returns: description (note: 'returns' not 'return' to match reST convention)
